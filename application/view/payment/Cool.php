...
<div class="container">
	<div class="row">
		...
		<script src="<?php echo Config::get('URL'); ?>payment/script"></script>
		 <form class="form-horizontal" action="<?php echo Config::get('URL'); ?>payment/create" method="post" id="payment-form">
            <fieldset>
                <!-- Address form -->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="postal-code" name="Zipcode" type="text" placeholder="zip or postal code"
                        class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
...
<script>
  ...
  var stripe = Stripe('pk_test_GGqAiGaGmOCRESmsEZWJWiK1009jrzZboQ');
