...
return array(
    ...
    *Stripe API KEYS
    **/
    'STRIPE_PUBLIC_API' => "pk_test_GGqAiGaGmOCRESmsEZWJWiK1009jrzZboQ')",
    'STRIPE_PRIVATE_KEY' => "sk_test_p97GTHVtbQP5pmSmOJk1QvKn00qyrAg6dT",
    /**
    *Tiny Cloud API Key
    **/
    'TINY_CLOUD_KEY' => "pj6bdxqrw0o1jhmhamnkiooxlmx8re28sh4vqk7hbtu3hrxd",
    'TINY_CLOUD_ENABLED' => '0' // If this is set to 0 a diffrent HTML Editor will be used, this allows for offline development or cheaper projects
);
