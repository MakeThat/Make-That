...
return array(
    ...
    "FEEDBACK_ACCOUNT_CHARGED" => "Your Card has been charged for a value of $",
    "FEEDBACK_CHARGE_FAILED" => "The Charge on your account has failed please try agian or reach out to support",
    "FEEDBACK_CUSTOMER_DELETED" => "This customer has been sucessful deleted",
    "FEEDBACK_CUSTOMER_DELETED_FAIL" => "There was a problem when deleting this customer",
    "FEEDBACK_MAKERSPACE_INFO_UPDATED" => "There Makerspace account was updated",
    "FEEDBACK_PLAN_CREATED" => "Plan Was created Sucessfully",
    "FEEDBACK_PLAN_CREATION_ERROR" => "There was an error in creating this plan",
    "FEEDBACK_SUBSCRIPTION_DISABLED" => "Subscription Status Was updated",
    "FEEDBACK_TOOL_ADDED" => "Tool Was sucessfully added",
    "FEEDBACK_TOOL_FAILED" => "Tool was not added sucessfully",
    "FEEDBACK_TOOL_DISABLED" => "Tool was sucessfully disabled",
    "FEEDBACK_TOOL_DELETED" => "Tool was sucessfull deleted",
    "FEEDBACK_TOOL_ERROR" => "There was an error with this action"
);
